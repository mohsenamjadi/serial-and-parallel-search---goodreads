...
std::vector<bookRate> search_in_reviewsFile(std::vector<Book> book)
{
	...
	input_file.open("/home/mohsen/Documents/OS-course-project-3/T3/serial/reviews.csv");
...
std::vector<Book> Search_in_booksFile(std::string search_term)
{
	...
	std::ifstream input_file;
	input_file.open("/home/mohsen/Documents/OS-course-project-3/T3/serial/books.csv");
